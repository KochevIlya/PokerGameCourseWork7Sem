...
class MockCard:
    ...
    def __init__(self, suite="Spade", value='9'):
        if suite not in MockCard.static_suites:
            raise ValueError("Invalid suite " + suite)
        if value not in MockCard.static_cardvalues:
    ...
    def __sub__(self, other):
        ...
        if self.value == "2" and other.value == "A":
            return 1
        return MockCard.static_cardvalues.index(self.value) - MockCard.static_cardvalues.index(other.value)
