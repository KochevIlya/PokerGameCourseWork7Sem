...
StaticLogger.configure("Experiment_with_smaller_batch_size_calling_player_train_off.log", 1000)
...
pm.load_ac_agent(filename="neural_ac_agent_small_batch_calling_player_2.pth")
